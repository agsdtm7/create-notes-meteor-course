...
if(Meteor.isClient){
  describe('Editor', function(){
    ...
    it('should remove note', function(){
      ...
      // this test means when we click delete buttons two things happen: first set the url to dashboard
      // second call the method remove notes (handleDeleteNote) with 2 arguments
