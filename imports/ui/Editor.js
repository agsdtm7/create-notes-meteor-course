    ...
    if(this.props.note){
          return(
            <div className="editor">
              <input className="editor__title" value={this.state.title} placeholder="Your Note Title" onChange={this.handleTitleChange.bind(this)} /> {/*setup value, placeholder and onchange. then create handleTitleChange*/}
